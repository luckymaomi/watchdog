...
| --- | --- | --- |
| 菜鸟教程 | 🧪 | 哈哈。好活。置顶。 |
| 培训皇帝 | ✅ | 查个人资质、排培训、核对覆盖率、年度负载均衡、更新有效期 |
| 换季学习 | ✅ | 换季学习负载均衡 |
| 审计之王 | ✅ | 从检查项检索手册证据，整理审计依据和 PDF 页面 |
| 校对之王 | 🧪 | 比对同一本手册新旧版，增删改情况。 |
| 姓名匹配员工号 | ✅ | 识别姓名并匹配员工号 |
| 酒店皇帝 | ✅ | 对比酒店账单与入住登记表 |
| 重点人员标注 | ✅ | 在审班表中标注重点人员 |
| 航线班次统计 | ✅ | 按排班表统计每人各航线班次 |
| 实力周报 | ✅ | 用多份飞行实力表生成技术细分、带队资格与分类横向对比图 |
...
| 运行资质比对 | ✅ | 按员工号核对人员信息与飞行门户运行资质名册 |
| 英语汉语有效期比对 | ✅ | 按姓名核对人员信息与局方执照备注中的英语、汉语有效期 |
| 国际航班资质反推 | ✅ | 按地区机场和反推日期查找近期国际航班并导出 |
| 锁班乞丐 | 🧊 | 乞丐版，用playwright自动化模拟锁班。 |
| 飞行经历查询（乞丐版） | 🧊 | playwright批量查询飞行时间+起落数、飞行经历+起落数、左座经历+起落数或全部数据 |
| 珠海皇帝 | 🧊 | 核对场次表与账单表姓名人次 |
